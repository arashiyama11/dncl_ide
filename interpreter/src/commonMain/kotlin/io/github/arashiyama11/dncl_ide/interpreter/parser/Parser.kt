...
import io.github.arashiyama11.dncl_ide.interpreter.model.ExpressionStopToken
import io.github.arashiyama11.dncl_ide.interpreter.model.InfixExpressionToken
...
class Parser private constructor(private val lexer: ILexer) : IParser {
    ...
    private fun parseStatement(): Either<DnclError, AstNode.Statement> = either {
        val node = when (currentToken) {
            ...
            is Token.Identifier, is Token.Japanese -> when (nextToken) {
